<?php
/***************************************************************************
 * template.php - Camp Wabashi Template 3.0
 * -------------------------------------------------------------------------
...
echo '
    ...
    <p><a target="policy" href="' . $CFG->wwwroot . '/features/events/templates/camp_2025/regpolicy.html">Registration Policy</a></p>';
 ...
 echo ' <input type="hidden" id="event_begin_date" value="' . date("Y-m-d", $event["event_begin_date"]) . '" />
        ...
        <input type="hidden" name="HealthConsentTo" id="HealthConsentTo" value="' . date("Y-m-d", $event["event_end_date"]) . '" readonly />
            ...
            <div class="rowContainer">
                <label class="rowTitle" for="email">Email Address *</label><input tabindex="1" type="text" id="email" name="email" data-rule-required="true" data-rule-email="true" data-msg-required="' . error_string('valid_req_email') . '" data-msg-email="' . error_string('valid_email_invalid') . '" /><div class="tooltipContainer info">' . get_help("help_email:events:templates/camp_2025") . '</div>
            ...
            <div class="rowContainer">
                <label class="rowTitle" for="Camper_Name_Middle">Camper Middle Initial</label><input tabindex="4" style="width:50px;" maxlength="1" type="text" id="Camper_Name_Middle" name="Camper_Name_Middle" data-rule-maxlength="1" data-rule-letters="true" /><div class="tooltipContainer info">' . get_help("help_middlei:events:templates/camp_2025") . '</div>
                      <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer">
                    ...
                    <div class="tooltipContainer info">' . get_help("help_bday:events:templates/camp_2025") . '</div>
                    <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer">
                <label class="rowTitle" for="Camper_Age">Age during week</label><input style="background-color: lightgray;border: 1px solid grey; width:50px;" type="text" id="Camper_Age" name="Camper_Age" data-rule-required="true" data-rule-number="true" ' . $min_age.$max_age.$min_age_error.$max_age_error . ' readonly /><div class="tooltipContainer info">' . get_help("help_age:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer">
                <label class="rowTitle" for="Camper_Grade">Last Completed Grade *</label><input tabindex="5" style="width:50px;" type="text" size="2" maxlength="2" id="Camper_Grade" name="Camper_Grade" data-rule-required="true" data-rule-number="true" data-rule-max="12" data-rule-min="0" /><div class="tooltipContainer info">' . get_help("help_grade:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer">
                ...
                <div class="tooltipContainer info">' . get_help("help_gender:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
                <div class="rowContainer">
                <label class="rowTitle" for="Camper_Home_Congregation">Home Congregation</label><input tabindex="7" type="text" id="Camper_Home_Congregation" name="Camper_Home_Congregation" data-rule-nonumbers="true" /><div class="tooltipContainer info">' . get_help("help_congregation:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer">
                <label class="rowTitle" for="Parent_Name">Parent/Guardian *</label><input tabindex="8" type="text" id="Parent_Name" name="Parent_Name" data-rule-required="true" data-rule-nonumbers="true" /><div class="tooltipContainer info">' . get_help("help_parent:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer">
                <label class="rowTitle" for="Parent_Address_Line1">Mailing Address Line One *</label><input tabindex="9" type="text" id="Parent_Address_Line1" name="Parent_Address_Line1" data-rule-required="true" /><div class="tooltipContainer info">' . get_help("help_address:events:templates/camp_2025") . '</div>
                  <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer">
                <label class="rowTitle" for="Parent_Address_Line2">Mailing Address Line Two</label><input tabindex="10" type="text" id="Parent_Address_Line2" name="Parent_Address_Line2" /><div class="tooltipContainer info">' . get_help("help_address:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer">
                <label class="rowTitle" for="Parent_Address_City">City *</label><input tabindex="11" type="text" id="Parent_Address_City" name="Parent_Address_City" data-rule-required="true" data-rule-nonumbers="true" /><div class="tooltipContainer info">' . get_help("help_city:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer">
                ...
                <div class="tooltipContainer info">' . get_help("help_state:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer">
                <label class="rowTitle" for="Parent_Address_Zipcode">Zipcode *</label><input tabindex="13" type="text" size="5" maxlength="5" id="Parent_Address_Zipcode" name="Parent_Address_Zipcode" data-rule-required="true" data-rule-number="true" data-rule-minlength="5" /><div class="tooltipContainer info">' . get_help("help_zip:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer">
                <label class="rowTitle" for="Parent_Phone1">Parent/Guardian Phone 1 *</label><input tabindex="14" type="text" maxlength="22" id="Parent_Phone1" name="Parent_Phone1" data-rule-required="true" data-rule-phone="true" /><div class="tooltipContainer info">' . get_help("help_phone:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer">
                <label class="rowTitle" for="Parent_Phone2">Parent/Guardian Phone 2 *</label><input tabindex="15" type="text" maxlength="22" id="Parent_Phone2" name="Parent_Phone2" data-rule-required="true" data-rule-phone="true" /><div class="tooltipContainer info">' . get_help("help_phone:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer">
                <label class="rowTitle" for="Parent_Phone3">Parent/Guardian Phone 3</label><input tabindex="16" type="text" maxlength="22" id="Parent_Phone3" name="Parent_Phone3" data-rule-phone="true" /><div class="tooltipContainer info">' . get_help("help_phone:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer">
                <label class="rowTitle" for="Parent_Phone4">Parent/Guardian Phone 4</label><input tabindex="17" type="text" maxlength="22" id="Parent_Phone4" name="Parent_Phone4" data-rule-phone="true" /><div class="tooltipContainer info">' . get_help("help_phone:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
            ...
            <div style="font-size:12px;">
                <p style="text-align:left;width:85%">
                 ...
                 <div class="rowContainer">
                <label class="rowTitle" for="HealthMemberName">Member\'s Name *</label><input tabindex="18" type="text" id="HealthMemberName" name="HealthMemberName" data-rule-required="true" data-rule-nonumbers="true" /><div class="tooltipContainer info">' . get_help("help_membername:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
                 <div class="rowContainer">
                <label class="rowTitle" for="HealthRelationship">Relationship *</label><input tabindex="19" type="text" id="HealthRelationship" name="HealthRelationship" data-rule-required="true" data-rule-nonumbers="true" /><div class="tooltipContainer info">' . get_help("help_relationship:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
                 <div class="rowContainer">
                <label class="rowTitle" for="HealthInsurance">Medical Insurance Carrier *</label><input tabindex="20" type="text" id="HealthInsurance" name="HealthInsurance" data-rule-required="true" /><div class="tooltipContainer info">' . get_help("help_carrier:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer">
                <label class="rowTitle" for="HealthIdentification">Medical Identification Number</label><input tabindex="21" type="text" id="HealthIdentification" name="HealthIdentification" /><div class="tooltipContainer info">' . get_help("help_memberid:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer">
                ...
                <div class="tooltipContainer info">' . get_help("help_membercode:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer">
                ...
                <div class="tooltipContainer info">' . get_help("help_memberaccount:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer">
                ...
                <div class="tooltipContainer info">' . get_help("help_healthto:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer" style="height: auto;">
                ...
                <div class="tooltipContainer info">' . get_help("help_history:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer" style="height: auto;">
                ...
                <div class="tooltipContainer info">' . get_help("help_alergies:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer" style="height: auto;">
                ...
                <div class="tooltipContainer info">' . get_help("help_existing:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer" style="height: auto;">
                ...
                <div class="tooltipContainer info">' . get_help("help_meds:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>
            <div class="rowContainer">
                ...
                <div class="tooltipContainer info">' . get_help("help_tetanus:events:templates/camp_2025") . '</div>
                <div class="spacer" style="clear: both;"></div>
            </div>';
}
    ...
    if ($event['fee_full'] > 0 && $pictures_price > 0) {
        echo '
            <div class="rowContainer">
                ...
                <div class="tooltipContainer info">' . get_help("help_pictures:events:templates/camp_2025") . ' ($' . $pictures_price . '.00 for 8x10 group photo)</div>
                <div class="spacer" style="clear: both;"></div>
            </div>';
    } else {
...
if ($shirt) {
    ...
    if ($event['fee_full'] > 0 && $shirt_price > 0) {
        ...
        echo '
            ...
            <div class="tooltipContainer info">' . get_help("help_shirt:events:templates/camp_2025") . ' ($' . $shirt_price . '.00 for camp shirt)</div>
            <div class="spacer" style="clear: both;"></div>
        </div>
        ';
    } else {
        ...
        <div class="rowContainer">
            ...
            <div class="tooltipContainer info">' . get_help("help_shirt_size:events:templates/camp_2025") . ' (no extra charge)</div>
            <div class="spacer" style="clear: both;"></div>
        </div>';
    }
} else {
...
if ($event['fee_full'] > 0) {
    if (empty($payment_method) || $payment_method == "Paypal") { // Don't show for camperships or check/money order payments.
        ...
        <div class="rowContainer costinfo paywithapp">
            ...
            <div class="tooltipContainer info">' . get_help("help_paywithapp:events:templates/camp_2025") . '</div>
            <div class="spacer" style="clear: both;"></div>
        </div>';
    }
    ...
    if (!$show_again) {
        ...
        <div class="rowContainer" id="campershiprow" style="display: none">
            ...
            <input tabindex="32" type="text" id="campership" name="campership" /><div class="tooltipContainer info">' . get_help("help_campership:events:templates/camp_2025") . '</div>
            <div class="spacer" style="clear: both;"></div>
        </div>
        <div class="rowContainer" style="height: auto;">
