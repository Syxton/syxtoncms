...
<table>
  ...
  <tr><td colspan="2"><p>
    <a target="policy" href="' . $CFG->userfilesurl . '/1/file/regpolicy.html">Registration Policy</a>
  </p></td></tr>';
 ...
 echo '
        ...
        <tr>
          ...
          <tr>
            ...
            <td><textarea name="HealthHistory" rows="8" cols="60">-none-</textarea></td>
          </tr>
          <tr>
            <td align="right"><strong><font size="2">Allergies&nbsp;*&nbsp;</font></strong></td>
            <td><textarea name="HealthAllergies" rows="8" cols="60">-none-</textarea></td>
          </tr>
          <tr>
            <td align="right"><strong><font size="2">Chronic/existing diseases/medical problems&nbsp;*&nbsp;</font></strong></td>
            <td><textarea name="HealthExisting" rows="8" cols="60">-none-</textarea></td>
          </tr>
          <tr>
            <td align="right"><strong><font size="2">Medicines&nbsp;*&nbsp;</font></strong></td>
            <td><textarea name="HealthMedicines" rows="8" cols="60">-none-</textarea></td>
          </tr>
          <tr>
    ...
    echo '<tr>
          <td align="right"><strong><font size="2">Camp&nbsp;Picture:&nbsp;</font></strong></td>
           <td><input name="Camper_Picture" value="' . $picturecost . '" onchange="updateTotal();" onclick="updateTotal();" type="radio">Yes
            <input name="Camper_Picture" value="0" onchange="updateTotal();" onclick="updateTotal();" checked=checked type="radio">No
            &nbsp;&nbsp;($' . $picturecost . '.00 for 8x10 color picture of all campers and staff)
          </td>
        </tr>';
}
echo
...
if (!$show_again) {
    ...
    <tr>
      ...
      <td><textarea name="payment_note" rows="8" cols="60">After you select a payment method, you can put a message here.
