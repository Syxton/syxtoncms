...
function updateMessage() {
    ...
    if (document.form1.payment_method.selectedIndex == 1) {
        ...
        message = message + "Your credit card or bank account information is not transmitted to us. ";
        message = message + "You do not need a PayPal account to make payment using most major credit cards, ";
        message = message + "but we do encourage you to become a verified member. ";
        message = message + "A PayPal payment button will be displayed after you click on the Send Application button.\n\n";
        message = message + "PayPal timeout issues can be avoided by clearing your temporary internet files and cookies ";
        message = message + "and adding https://www.paypal.com/ to your list of trusted sites.";
    }
...
function updateTotal() {
    ...
    if (document.form1.Camper_Picture) {
        if (document.form1.Camper_Picture[0].checked) total += parseFloat(document.form1.Camper_Picture[0].value);
    }
