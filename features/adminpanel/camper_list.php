...
//    $allcamperlist1 = array_distinct($allcamperlist,"1",null,NULL); //Removes duplicate Camper_Name's'
//    echo "<br /><a href='javascript:".get_download_link("camperlist1.csv",$allcamperlist1,true)."'>Download All Campers List</a><br />";
//    
//    $retreatcamperlist1 = array_distinct($retreatcamperlist,"1",null,NULL); //Removes duplicate Camper_Name's'
//    echo "<br /><a href='javascript:".get_download_link("youthretreatlist1.csv",$retreatcamperlist1,true)."'>Download Retreat 13+ List</a>";
//    
//    
    $allcamperlist = array_distinct_new($allcamperlist,array(1,3),"80"); //Removes duplicate Camper_Name's'
    echo "<br /><a href='javascript:".get_download_link("camperlist2.csv",$allcamperlist,true)."'>Download All Campers List</a>";
    
    $retreatcamperlist = array_distinct_new($retreatcamperlist,array(1,3),"80"); //Removes duplicate Camper_Name's'
    echo "<br /><a href='javascript:".get_download_link("youthretreatlist2.csv",$retreatcamperlist,true)."'>Download Retreat 13+ List</a>";
}
