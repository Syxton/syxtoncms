    ...
    $.ajax({
      ...
      cache: false,
        ...
        if (!json.latitude) {
            ...
            ajaxapi_old('/features/adminpanel/adminpanel_ajax.php','ipmap','&json='+JSON.stringify(json),function(){if (xmlHttp.readyState == 4) { document.getElementById(divname).innerHTML = xmlHttp.responseText; } }, true);
        }
      }
    });
}
