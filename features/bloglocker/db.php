...
function bloglocker_upgrade() {
	global $CFG;

    $version = get_db_field("version", "features", "feature='bloglocker'");	
    $thisversion = 20100819;
	if ($version < $thisversion) { execute_db_sql("UPDATE features SET version='$thisversion' WHERE feature='bloglocker'"); }
