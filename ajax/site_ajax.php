...
global $CFG, $MYVARS;
	...
	echo fill_template("tmp/page.template", "setting_change_template", false, ["wwwroot" => $CFG->wwwroot, "success" => $success]);
}
...
function delete_user() {
	...
	echo fill_template("tmp/site_ajax.template", "delete_user_template", false, $params);
}
