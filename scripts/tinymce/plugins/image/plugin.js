...
tinymce.PluginManager.add('image', function(editor) {
	...
	var title="RESPONSIVE FileManager";
        ...
        win = editor.windowManager.open({
            ...
            data: data,
            classes: 'filemanager',
            file: tinyMCE.baseURL + '/plugins/filemanager/dialog.php?type=1&editor=' + editor.id + '&lang=' + tinymce.settings.language + '&dir=' + $('#icpbl_pageid').val(),
            filetype: 'image',
            width: 900,
            height: 600,
            inline: 1
	...
	function showDialog(imageList) {
		...
		var generalFormItems = [
            ...
            direction: 'row',
				items: [
					{name: 'src',type: 'textbox',filetype: 'image',size: 35,classes: 'img_' + clean_id, autofocus: true},
					{name: 'upl_img', type: 'button', classes: 'btn open',icon: 'browse',onclick: openmanager,tooltip: 'Upload image'}
			]
			},

			imageListCtrl,
			{name: 'alt', classes: 'alt_img_' + clean_id, type: 'textbox', label: 'Image description'},
			{
				type: 'container',
				label: 'Dimensions',
				layout: 'flex',
				...
				spacing: 5,
				items: [
					{name: 'width', classes: 'width_img_' + clean_id, type: 'textbox', maxLength: 3, size: 3, onchange: recalcSize},
					{type: 'label', text: 'x'},
					{name: 'height', classes: 'height_img_' + clean_id ,type: 'textbox', maxLength: 3, size: 3, onchange: recalcSize},
