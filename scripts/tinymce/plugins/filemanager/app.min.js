...
if (dragging.isFolder && (state.path ? state.path + '/' : '') + dragging.name === toPath) return; 
e.preventDefault();
...
e.preventDefault();
var moved = dragging;
if (toPath === state.path) return; 
if (moved.isFolder && (state.path ? state.path + '/' : '') + moved.name === toPath) return; 
