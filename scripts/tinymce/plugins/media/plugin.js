...
tinymce.PluginManager.add('media', function(editor, url) {
    ...
    function openmanager(types) {
        ...
        win = editor.windowManager.open({
            ...
            data: data,
            classes: 'filemanager',
            file: tinyMCE.baseURL + '/plugins/filemanager/dialog.php?type=' + types + '&editor=' + editor.id + '&lang=' + tinymce.settings.language + '&dir=' + $('#icpbl_pageid').val(),
            filetype: 'file',
            width: 900,
            height: 600,
            inline: 1
	...
	function showDialog() {
		...
		win = editor.windowManager.open({
            ...
            direction: 'row',
				items: [
                	{name: 'source1', type: 'textbox', filetype: 'media', size: 35, autofocus: true, classes: 'video3_' + clean_id},
                	{name: 'upl_video', type: 'button', classes: 'btn open',icon: 'browse', onclick: function() { openmanager(3) } , tooltip: 'Select video'}
                	]
                }, {
            type: 'container',
            layout: 'flex',
            ...
            direction: 'row',
				items: [
					{name: 'source2', type: 'textbox', filetype: 'media', size: 35, classes: 'video4_' + clean_id},
					{name: 'upl_video1', type: 'button', classes: 'btn open',icon: 'browse', onclick: function() { openmanager(4) } , tooltip: 'Select video'}
					]
                }, {
            type: 'container',
            layout: 'flex',
            ...
            direction: 'row',
				items: [
					{name: 'poster', type: 'textbox', filetype: 'image', size: 35, classes: 'video5_' + clean_id},
					{name: 'upl_video2', type: 'button', classes: 'btn open',icon: 'browse', onclick: function() { openmanager(5) } , tooltip: 'Select video'}
					]
                }, {
							type: 'container',
							label: 'Dimensions',
